...
sub usage
{
	print "\nUsage: update-cfg.pl <path-to-RTM_Linux.cfg-file>\n\n";
	print "This perl script will read the RTM_Linux configuration file\n";
...
# will be changed to something like the example below in a later version of RTM_LINUX.
