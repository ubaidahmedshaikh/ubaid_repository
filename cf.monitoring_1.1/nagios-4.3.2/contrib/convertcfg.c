...
int main(int argc, char **argv) {
	...
	if(argc != 3) {
		printf("Real time Monitoring Config File Converter\n");
		...
		printf("\n");
		printf("IMPORTANT: This utility will generate Real time Monitoring 1.x compliant config files.\n");
		printf("However, the config files are not totally compatible with Real time Monitoring 2.x, so\n");
