...
void show_service_detail(void) {
	...
	if(user_has_seen_something == FALSE) {
		...
		if(servicestatus_list != NULL) {
			...
			printf("Make sure that Real Time Monitoring is running and that you have specified the location of you status log correctly in the configuration files.</div></p>\n");
			}
		}
	else {
...
//	printf("<P>\n");
	...
	printf("<div align='center' class='statusTitle'>Asset Monitoring Status Details For ");
	if(show_all_hostgroups == TRUE)
		printf("All Asset Monitoring Groups");
	else
		printf("Host Group '%s'", hostgroup_name);
	printf("</div>\n");
...
void show_hostgroup_summaries(void) {
	...
	if(user_has_seen_something == FALSE && hostgroup_error == FALSE) {
		...
		if(hoststatus_list != NULL) {
			...
			printf("Make sure that Real Time Monitoring is running and that you have specified the location of you status log correctly in the configuration files.</div>\n");
			}
