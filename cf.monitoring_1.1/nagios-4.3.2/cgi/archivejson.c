...
option_help archive_json_help[] = {
		...
		},
	{
		...
		{ "alertcount", "alertlist", "notificationcount", "notificationlist",
				NULL },
		NULL,
		"Limits the hosts or services returned to those whose host parent is specified. A value of 'none' returns all hosts or services reachable directly by the Real Time Monitoring core host.",
		parent_host_extras
		},
	{
		"childhost",
		...
		},
	{
		...
		"Assume States During NagNagiosios Downtime",
		"boolean",
		{ NULL },
		{ "availability", NULL },
		NULL,
		"Assume states are retained during Real Time Monitoring downtime.",
		NULL
		},
	{
