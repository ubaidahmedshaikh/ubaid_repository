...
void document_header(int use_stylesheet) {
	...
	printf("<title>\n");
	printf("Real Time Monitoring Availability\n");
	printf("</title>\n");
...
void display_host_availability(void) {
	...
	if(show_all_hosts == FALSE) {
		...
		printf("<td CLASS='dataOdd'>Real Time Monitoring Not Running</td><td CLASS='dataOdd'>%s</td><td CLASS='dataOdd'>%2.3f%%</td><td CLASS='dataOdd'></td></tr>\n", time_indeterminate_notrunning_string, percent_time_indeterminate_notrunning);
...
void display_service_availability(void) {
	...
	if(show_all_services == FALSE) {
		...
		printf("<td CLASS='dataEven'>Real Time Monitoring Not Running</td><td CLASS='dataEven'>%s</td><td CLASS='dataEven'>%2.3f%%</td><td CLASS='dataEven'></td></tr>\n", time_indeterminate_notrunning_string, percent_time_indeterminate_notrunning);
