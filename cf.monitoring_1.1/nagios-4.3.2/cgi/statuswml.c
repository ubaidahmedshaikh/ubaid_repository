...
void display_index(void) {
	...
	printf("<card id='card1' title='Real Time Monitoring WAP Interface'>\n");
	printf("<p align='center' mode='nowrap'>\n");

	printf("<b>Real Time Monitoring</b><br/><b>WAP Interface</b><br/>\n");
	...
	printf("<b>Real Time Monitoring %s</b><br/><b>WAP Interface</b><br/>\n", PROGRAM_VERSION);
...
void display_process(void) {
	...
	if(nagios_process_state == STATE_OK)
		printf("Real Time Monitoring process is running<br/>\n");
	else
		printf("<b>Real Time Monitoring process may not be running</b><br/>\n");
