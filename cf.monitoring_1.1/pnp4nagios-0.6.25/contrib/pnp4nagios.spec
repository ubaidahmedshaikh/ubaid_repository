...
%configure --with-perfdata-logfile=%{_localstatedir}/log/rtm/perfdata.log \
	--sysconfdir=%{_sysconfdir}/%{name} \
	--datarootdir=%{_datadir}/%{name} \
	--with-perfdata-dir=%{_datadir}/%{name}/perfdata \
	--with-perfdata-spool-dir=%{_localstatedir}/spool/rtm \
	--mandir=%{_mandir} \
...
sed -i -e 's*log_file = /var/npcd.log*log_file = /var/log/rtm/npcd.log*' %{buildroot}%{_sysconfdir}/%{name}/npcd.cfg
