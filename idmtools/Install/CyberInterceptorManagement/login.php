...
<div style="display:inline-block;margin-top:10px;"><img src="images/cyberforza_logo.png" alt="" style="width:100px;margin-left: 10%;max-width:200px;">
		...
		<div>
		<h1 style="margin-left:20%;color:#1e406d;"><b>Welcome to CISS-Interceptor </b></h1><br><br>
		</div>
<div style="display:flex;">	
		...
		<h2 style="background:none;color:#1e406d;"> Admin Manager</h2>	
				<form name="login" action="dologin.php" class="sidebar" method="post" >
					<ul class="subnav">
				<!--		<li><select name="menu" tabindex=3 class="generic" value="Radius Server">
						     <option selected="selected" value="login.php">Radius Server</option>
						        <option value="http://192.168.50.150/CyberInterceptorAdmin/index.php?cmd=login_form">LDAP/AD</option>
  						     </select></li>
		...
		<h2 style="background:none;font: 160% Arial;color:#1e406d;margin: 10px 0 10px 0;"> Corporate Security</h2>	
                  <ul class="nav nav-tabs" style="display:;list-style: none;border:none">

                	<li class=""><button type="button" data-toggle="modal" data-target="#myModal1" class="btn btn-default" ><img src="images/image001.png" width="600px" height="325"><br>
		</button></li></ul>
		</div>	
		</div>	
		</div>
