...
echo "
        ...
        <fieldset>
                ...
                <h302>Administrator Details</h302>
                <br/>

                <label for='firstname' class='form'>Administrator Firstname</label>
                <input name='firstname' type='text' id='firstname' 
			value='".$operator_firstname."' >
                <br/>

                <label for='lastname' class='form'>Administrator Lastname</label>
                <input name='lastname' type='text' id='lastname' 
			value='".$operator_lastname."' >
                <br/>

                <label for='title' class='form'>Administrator Title</label>
                <input name='title' type='text' id='title'
			value='".$operator_title."' >
                <br/>

                <label for='department' class='form'>Administrator Department</label>
                <input name='department' type='text' id='department'
			value='".$operator_department."' >
                <br/>

                <label for='company' class='form'>Administrator Company</label>
                <input name='company' type='text' id='company'
			value='".$operator_company."' >
                <br/>

                <label for='phone1' class='form'>Administrator Phone1</label>
                <input name='phone1' type='text' id='phone1'
			value='".$operator_phone1."' >
                <br/>

                <label for='phone2' class='form'>Administrator Phone2</label>
                <input name='phone2' type='text' id='phone2'
			value='".$operator_phone2."' >
                <br/>

                <label for='email1' class='form'>Administrator Email1</label>
                <input name='email1' type='text' id='email1'
			value='".$operator_email1."' >
                <br/>

                <label for='email2' class='form'>Administrator Email2</label>
                <input name='email2' type='text' id='email2'
			value='".$operator_email2."' >
                <br/>

                <label for='messenger1' class='form'>Administrator Messenger1</label>
                <input name='messenger1' type='text' id='messenger1'
			value='".$operator_messenger1."' >
                <br/>

                <label for='messenger2' class='form'>Administrator Messenger2</label>
                <input name='messenger2' type='text' id='messenger2'
			value='".$operator_messenger2."' >
                <br/>

                <label for='notes' class='form'>Administrator Notes</label>
	        <textarea class='form' name='notes' id='notes'>".$operator_notes."</textarea>
                <br/>

		<br/>
                <label for='operator_lastlogin' class='form'>Administrator Last Login</label>
