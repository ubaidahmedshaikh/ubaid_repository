...
<div class="tabber">
     ...
     <div class="tabbertab" title="<?php echo $l['title']['daloRADIUSTables']; ?>">
		...
		<br/>
                ...
                <li class='fieldset'>
                <label for='backup_dalooperators' class='form'>administrators</label> 
		...
		<select class='form' name="billing_history">
			...
			<option value="yes">yes</option>
                ...
                <li class='fieldset'>
                <label for='backup_operators_acl' class='form'>administrators_acl</label> 
		<select class='form' name="operators_acl">
			...
			<option value="yes">yes</option>
                ...
                <li class='fieldset'>
                <label for='backup_operators_acl_files' class='form'>administrators_acl_files</label> 
