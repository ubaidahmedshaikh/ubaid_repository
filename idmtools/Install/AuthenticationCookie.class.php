...
class AuthenticationCookie extends AuthenticationPlugin
{
    ...
    public function auth()
    {
        ...
        $header->setTitle('CyberInterceptorDB');
    ...
    <div class="container">
    <a href="';
        echo PMA_linkURL('http://www.cyberforza.com/');
        echo '" target="_blank" class="logo">';
        $logo_image = $GLOBALS['pmaThemeImage'] . 'logo_right.png';
        if (@file_exists($logo_image)) {
            echo '<img src="' . $logo_image
                . '" id="imLogo" name="imLogo" alt="phpMyAdmin" border="0" style="margin:1px -85px; height:70px;" />';
        } else {
