...
$servers->setValue('server','name','CYBER INTERCEPTOR ADMIN');
...
$servers->setValue('server','base',array('dc=cyberforza,dc=com'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
$servers->setValue('login','bind_id','cn=admin,dc=cyberforza,dc=com');
