...
<head>
  ...
  <script src="/static/js/techDetails.js"></script>
...
<div class="col-sm-12 table_content">
  <h2>Most Used Front End Tech</h2>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body ips">
                <button type="button" id="download_ips" class="btn btn-info" onclick="download_ips()">Export to csv</button><br/><br/>
                <table id="ips_table"></table>
              </div>
              <div class="modal-body cves">
                <button type="button" id="download_cves" class="btn btn-info" onclick="download_cves()">Export to csv</button><br/><br/>
                <table id="cves_table"></table>
              </div>
...
<footer class="container-fluid">
  <div class="footer-copyright py-3 text-center">
      Contact @ <a href="mailto:info@cyberforza.com"> CyberForza </a>
  </div>
</footer>
