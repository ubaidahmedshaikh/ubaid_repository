...
$(document).ready(function(){
	var i=0;
	var url = "/server.php?type=external&level=1&category=uniqueVul";
...
function download_cves(){
	...
	JSONToCSVConvertor(uniqueVul_data, "Unique CVE's", true);
}
...
function show_cves(i){
	...
	$('.download_ips').click(function(){
        JSONToCSVConvertor(uniqueVul_data[i-1].ips, "Ips with Unique CVE", true);
    });
}
