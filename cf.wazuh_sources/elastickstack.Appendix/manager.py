...
def status():
    ...
    processes = ['threatanalytics-monitord', 'threatanalytics-logcollector', 'threatanalytics-remoted', 'threatanalytics-syscheckd', 'threatanalytics-analysisd', 'threatanalytics-maild', 'threatanalytics-execd', 'threatanalytics-modulesd', 'threatanalytics-authd']
